        ...
        if (request()->ajax()) {
            ...
            $sells = Transaction::leftJoin('contacts', 'transactions.contact_id', '=', 'contacts.id')
                ...
                ->select(
                    ...
                    'contacts.name',
                    'transactions.order_made',
                    'transactions.tracking_to_warehouse',
                    'transactions.shipping_channel',
                    'transactions.tracking_to_customer',
                    'transactions.tracking_send_to_customer',
